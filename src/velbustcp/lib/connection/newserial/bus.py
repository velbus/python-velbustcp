...
from velbustcp.lib.connection.newserial.factory import set_serial_settings, find_port
from velbustcp.lib.connection.newserial.serialprotocol import VelbusSerialProtocol
from velbustcp.lib.connection.newserial.writerthread import WriterThread
